...
import { ListaGorras3AFe } from '../helpers/ListaGorras3AFe';
import { Link } from "react-router-dom";
import LoadingImage from '../components/LoadingImage';

function CatFego3AFe() {
    ...
    const handleClick = (id, image, precio) => {
        const mensaje = `Hola, quiero comprar de la Categoría AAA (FE) el modelo ${id}, imagen del producto: https://stylecapshop.vercel.app/${image} por ${precio}$ por favor.`;
    ...
    const currentItems = ListaGorras3AFe.slice(indexOfFirstItem, indexOfLastItem);
    const totalPages = Math.ceil(ListaGorras3AFe.length / itemsPerPage);
    ...
    return (
        <div className="catFego" style={{ backgroundImage: `url(${BannerImage})` }}>
            <center>
                <div className='catFegotitle'>
                    <h1 className='text-glow'>AAA (Fe)</h1>
                </div>
            </center>
