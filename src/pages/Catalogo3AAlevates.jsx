...
function Catalogo3AAlevates() {
    ...
    const handleClick = (id, precio, image) => {
        const mensaje = `Hola, quiero comprar de la Categoria TOP QUALITY 1.1 (ALEVATES) el modelo ${id}, imagen del producto: https://stylecapshop.vercel.app/${image} por ${precio}$ por favor.`;
